...
Import the provided SQL file. The file is known as DATABASE db.sql located inside the source code root folder.

Browse the Doctor's Appointment Systsem in a browser. i.e. http://localhost/HSM/.
...
DATABASE NAME: 'cuidado'

# BUILDIN USER ACCOUNTS OF THIS PROJECT

ADMIN EMAIL:		admin@cuidado.com

ADMNIN PASSWORD:	123


DOCTOR EMAIL:		doctor@cuidado.com

DOCTOR PASSWORD:	123


PATIENT EMAIL:		patient@cuidado.com
...
Server Software: 	Apache/2.4.39 (Win64) PHP/8.2.4
